...
INSERT_NFT_ENTITY_TABLE='mrc_test_nft_contract_data'
...
def process(start, end):
    ...
    SLCT_QRY = f'select nft_address, json_data from {SELECT_NFT_CONTRACTS_TABLE} where JSON_VALID(json_data) = 1 limit {start}, {end}'
    ...
    try:
        ...
        INSRT = f'''
                    INSERT INTO {INSERT_NFT_ENTITY_TABLE} ( nft_address,
                                                                token_hash,
                                                                token_address,
                                                                token_id,
                                                                block_number_minted,
